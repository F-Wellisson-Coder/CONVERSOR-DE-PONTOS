...
def get_epsg_from_coords(lat, lon):
    """
    Retorna o código EPSG SIRGAS2000/UTM adequado com base na latitude/longitude.
    Funciona apenas para o Brasil (zonas 18S a 25S).
    """
...
def gpx_to_dxf(gpx_file_path, dxf_file_path):
    """
    Converte um GPX (latitude/longitude) para DXF com coordenadas UTM reais.
    Detecta automaticamente a zona UTM no Brasil.
    """
    try:
        ...
        print(point.name.index("003"))#_________________________________________________________________________________________________ARRUMAR!!
        time.sleep(2)
...
# Exemplo de uso
gpx_file = "C:\\Users\\Wellison\\Desktop\\teste\\arquivo.gpx"   # Caminho do arquivo GPX
dxf_file = "C:\\Users\\Wellison\\Desktop\\teste\\saida.dxf"    # Caminho do DXF de saída
